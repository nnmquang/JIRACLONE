...
import { CHANGE_ASSIGNESS, CHANGE_TASK_MODAL, HANDLE_CHANGE_POST_API_SAGA, REMOVE_USER_ASSIGN, UPDATE_STATUS_TASK_SAGA } from '../../../redux/constants/Cyberbugs.js/TaskContant';
...
export default function ModalCyberBugs(props) {
    ...
    const [ visibleEditor,setVisivileEditor] = useState(false); 
    const [ visibleEditor_comment,setVisivileEditor_comment] = useState(false);
    const [historyContent,setHistoryContent] = useState(taskDetailModal.description);
    const [historyContentCom,setHistoryContentCom] = useState(taskDetailModal.commentContent);
    const [content,setContent] = useState(taskDetailModal.description);
    const [contentCom,setContentCom] = useState(taskDetailModal.commentContent);
            ...
            {visibleEditor? <div><Editor
                ...
                <button className='btn btn-primary m-2' onClick={()=>{
                   ...
                   // dispatch({
                    ...
                    setVisivileEditor(!visibleEditor)
                }}>{jsxDescription}</div>}
    ...
    // const renderComment = () => {
    //     const jsxComment = ReactHtmlParser(taskDetailModal.commentContent);
    //     return <div>
    //     {visibleEditor_comment? <div><Editor
    //             name="commentContent"
    //             // onInit={(evt, editor) => editorRef.current = editor}
    //             initialValue={taskDetailModal.commentContent}
    //             init={{
    //                 height: 500,
    //                 menubar: false,
    //                 plugins: [
    ...
    //                 content_style: 'body { font-family:Helvetica,Arial,sans-serif; font-size:14px }'
    //             }}
    //             onEditorChange={(contentCom,editor)=>{
    //                 setContentCom(contentCom)                    }}
    //         />
    //         <button className='btn btn-primary m-2' onClick={()=>{
    //             dispatch({
    //                 type:HANDLE_CHANGE_POST_API_SAGA,
    ...
    //             //     value:content
    //             // })
    //             setVisivileEditor_comment(false);
    //         }}>Save</button>
    //         <button className='btn btn-primary m-2' onClick={()=>{
    //            dispatch({
    //                type:HANDLE_CHANGE_POST_API_SAGA,
    ...
    //         }}>Close</button>
    //          </div>:<div onClick={()=>{
    //             setHistoryContentCom(taskDetailModal.commentContent)
    //             setVisivileEditor_comment(!visibleEditor_comment)
    //         }}>{jsxComment}</div>}
                                            ...
                                            <div className='row'>
                                                {
                                                    taskDetailModal.assigness.map((user, index) => {
                                                        ...
                                                        <div  key={index} style={{ display: 'flex' }} className="item">
                                                            ...
                                                            <p className="name mt-1 ml-1" style={{width:'auto'}}>
                                                                {user.name}
